...
<html>
    <head>
        ...
        <link href="<?= base_url() ?>assets/css/lavish-bootstrap.css" rel="stylesheet" media="screen">
            ...
            <div id="mast" class="navbar navbar-inverse navbar-fixed-top">
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <span class="h1"><a class="navbar-brand" href="<?php echo base_url(); ?>">GeoLogic</a></span>
                    </div>
                        ...
                        <?php if (isset($my_controller)) : ?>   
                            <?php if ($logged_in) : ?>  
                                      ...
                                      <li><a href="#contact">Contact</a></li>//-->               
                                        <li class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a href="<?php echo base_url('auth'); ?>">Administrar usuarios</a></li>   
                                ...
                                <ul class="nav navbar-nav pull-right">
                                    ...
                                    <li><a href="<?php echo base_url('auth/logout'); ?>">Salir <i class="fa fa-sign-out"></i></a></li>
                                </ul>
                            <?php endif; ?> 
                        <?php endif; ?>     
                    </div><!--/.nav-collapse -->
