...
<head>
    ...
    <title>GEOlogic - Admin</title>
    <link type="text/css" rel="stylesheet" href="<?= base_url() ?>assets/css/bootstrap.min.css"/>
	<link type="text/css" rel="stylesheet" href="<?= base_url() ?>assets/css/macro.css"/>
...
<body>
    <div id="wrapper">
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                	<a href="/geologic/zonas"><i class="fa fa-random fa-fw"></i> Panel Principal</a>
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="page-header"><?=$page_title ?></h1>
                </div>
