		...
		<div class="gridPanel">
			<div class="panel-heading">
				<div class="row">
					...
					<div class="col-lg-6">					
						<a class="btn btn-warning btn-sm btn-newP" href="/geologic/piedraspreciosas/create">
			...
			<div class="panel-body">
				...
				#piedraspreciosasGrid tbody td:nth-child(2) {
					text-align: center;
				}
				
				#piedraspreciosasGrid tbody td:nth-child(5) {
					text-align: center;
				}
				
				#piedraspreciosasGrid tbody td:nth-child(6) {
					text-align: center;
				}
				
				#piedraspreciosasGrid tbody td:nth-child(7) {
					text-align: center;
				}
				
				#piedraspreciosasGrid tr th {
					text-align: center;
				}
