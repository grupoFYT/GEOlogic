...
$config['collections']['centros']         = 'centros';
...
$config['message_start_delimiter'] = '<p><i class="fa fa-info-circle"></i> '; 	// Message start delimiter
$config['message_end_delimiter']   = '</p>'; 	// Message end delimiter
$config['error_start_delimiter']   = '<p><i class="fa fa-exclamation-circle"></i> ';		// Error message start delimiter
